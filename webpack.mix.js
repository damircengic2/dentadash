...
mix.copy(paths.jqueryui + 'themes/base/images',  destVendors + 'public/assets/img',false);
...
// mix.copy(paths.bootstrapFormBuilder + 'assets',  destVendors + 'bootstrap-form-builder/assets/', false);
// mix.copy(paths.bootstrapFormBuilder + 'pyscripts',  destVendors + 'bootstrap-form-builder/pyscripts/', false);
...
// // jquery file upload
mix.copy(paths.blueimpfileupload + 'css/jquery.fileupload.css',  destVendors + 'blueimp-file-upload/css');
mix.copy(paths.blueimpfileupload + 'css/jquery.fileupload-ui.css',  destVendors + 'blueimp-file-upload/css');
mix.copy(paths.blueimpfileupload + 'css/jquery.fileupload-noscript.css',  destVendors + 'blueimp-file-upload/css');
mix.copy(paths.blueimpfileupload + 'css/jquery.fileupload-ui-noscript.css',  destVendors + 'blueimp-file-upload/css');
mix.copy(paths.blueimpfileupload + 'js/vendor/jquery.ui.widget.js',  destVendors + 'blueimp-file-upload/js');
mix.copy(paths.blueimpfileupload + 'js/jquery.iframe-transport.js',  destVendors + 'blueimp-file-upload/js');
mix.copy(paths.blueimpfileupload + 'js/jquery.fileupload.js',  destVendors + 'blueimp-file-upload/js');
mix.copy(paths.blueimpfileupload + 'js/jquery.fileupload-process.js',  destVendors + 'blueimp-file-upload/js');
mix.copy(paths.blueimpfileupload + 'js/jquery.fileupload-image.js',  destVendors + 'blueimp-file-upload/js');
mix.copy(paths.blueimpfileupload + 'js/jquery.fileupload-audio.js',  destVendors + 'blueimp-file-upload/js');
mix.copy(paths.blueimpfileupload + 'js/jquery.fileupload-video.js',  destVendors + 'blueimp-file-upload/js');
mix.copy(paths.blueimpfileupload + 'js/jquery.fileupload-validate.js',  destVendors + 'blueimp-file-upload/js');
mix.copy(paths.blueimpfileupload + 'js/jquery.fileupload-ui.js',  destVendors + 'blueimp-file-upload/js');
...
mix.copy(paths.blueimpgallerywithdesc + 'css/blueimp-gallery.min.css',  destVendors + 'blueimp-gallery-with-desc/css');
mix.copy(paths.blueimpgallerywithdesc + 'js/jquery.blueimp-gallery.min.js',  destVendors + 'blueimp-gallery-with-desc/js');
mix.copy(paths.blueimpgallerywithdesc + 'img',  destVendors + 'blueimp-gallery-with-desc/img',false);
//file upload page;
mix.copy( srcJs + 'pages/main.js', destJs + 'pages');

//fancybox
mix.copy(paths.fancybox + 'dist/css/jquery.fancybox.css',  destVendors + 'fancybox/css');
mix.copy(paths.fancybox + 'dist/helpers/css/jquery.fancybox-buttons.css',  destVendors + 'fancybox/css');
mix.copy(paths.fancybox + 'dist/helpers/css/jquery.fancybox-thumbs.css',  destVendors + 'fancybox/css');
mix.copy(paths.fancybox + 'dist/helpers/js/jquery.fancybox-buttons.js',  destVendors + 'fancybox/js');

mix.copy(paths.fancybox + 'dist/helpers/js/jquery.fancybox-media.js',  destVendors + 'fancybox/js');
mix.copy(paths.fancybox + 'dist/helpers/js/jquery.fancybox-thumbs.js',  destVendors + 'fancybox/js');
...
mix.copy( srcJs + 'jquery.mixitup.js', destJs );
