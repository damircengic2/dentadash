...
Route::group(['middleware' => ['admin']], function () {
    Route::get('admin/invoices/{id}/invoice_lines', 'InvoiceLineController@index');
    Route::post('admin/invoices/{id}/invoice_lines', 'InvoiceLineController@store');
    Route::get('admin/data/invoice_lines/{invoice_id}', 'InvoiceLineController@data');
    Route::get('admin/invoice_lines/{id}/edit', 'InvoiceLineController@edit');
    Route::get('admin/invoice_lines/{id}/delete', 'InvoiceLineController@destroy');
    Route::put('admin/invoice_lines/{id}', 'InvoiceLineController@update');
    Route::get('admin/data/invoices', 'InvoiceController@data')->name('admin.data.invoices');
    Route::get('admin/invoice/{id}/delete', 'InvoiceController@destroy');
    Route::get('admin/invoice/{id}/pdf', 'InvoiceController@pdf');
});

Route::post('admin/patientchart/postdata', 'AjaxdataController@patientChartPost')->name('patientchart.postdata');
Route::get('admin/patientchart/getdata', 'AjaxdataController@patientChartGet')->name('patientchart.getdata');
