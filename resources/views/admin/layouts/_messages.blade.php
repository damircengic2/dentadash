s<li class="dropdown messages-menu ">
    ...
    <ul class="dropdown-menu dropdown-messages mr-auto" aria-labelledby="dropdownMenuLink">
        ...
        <li class="unread message dropdown-item">
            <a href="javascript:;" class="message"> <i class="pull-right" data-toggle="tooltip"
                ...
                <img src="{{ asset('assets/img/authors/avatar.jpg') }}"
                     class="img-fluid message-image" alt="icon">
        ...
        <li class="unread message dropdown-item">
            <a href="javascript:;" class="message">
                <i class="float-right" data-toggle="tooltip" data-placement="top" title="Mark as Read">
                                    <span class="float-right ol livicon" data-n="adjust" data-s="10"
                                          data-c="#287b0b"></span>
                </i>
